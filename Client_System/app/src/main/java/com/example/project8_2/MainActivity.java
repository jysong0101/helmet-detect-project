...
*/
    ...
    private void uploadPostWithImage(String title, String text, Uri imageUri) {
        ...
        Request request = new Request.Builder()
                .url(siteUrl)
                .post(requestBody)
                .addHeader("Authorization", "Token 5f16ab618d07687de55f0df65fc5c9ff5838683e") 
                .build();
    ...
    private class CloadImage extends AsyncTask<String, Integer, List<ImageData>> {
        ...
        protected List<ImageData> doInBackground(String... urls) {
            ...
            try {
                ...
                String token = "5f16ab618d07687de55f0df65fc5c9ff5838683e"; 
                ...
                if (conn.getResponseCode() == HttpURLConnection.HTTP_OK) {
                    ...
                    for (int i = 0; i < aryJson.length(); i++) {
                        ...
                        if (!imageUrl.isEmpty()) {
                            ...
                            imageDataList.add(new ImageData(id, title, text, imageBitmap));  
                            imgStream.close();
                        }
                    }
                }
    ...
    public void deletePost(int postId, int position) {
        OkHttpClient client = new OkHttpClient();
        String deleteUrl = siteUrl + postId + "/"; 
